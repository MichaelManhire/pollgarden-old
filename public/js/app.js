...
window.ballotBox = function (hasVoted, totalVotes) {
  return {
    ...
    vote: function vote() {
      ...
      var form = this.$el.querySelector('.js-ballot-box-form');
      var selectedOptionId = form.querySelector('input[name="option_id"]:checked').value;
      ...
      axios.post(form.getAttribute('action'), {
        ...
        if (response.status === 200) {
          ...
          _this.updateOptions(selectedOptionId);
    ...
    updateTotal: function updateTotal() {
      var totalWrapper = this.$el.querySelector('.js-total-votes');
      this.totalVotes = this.totalVotes + 1;
      totalWrapper.textContent = "".concat(this.totalVotes, " ").concat(this.totalVotes === 1 ? 'vote' : 'votes');
    },
    updateOptions: function updateOptions(selectedOptionId) {
      var totalVotes = parseInt(this.totalVotes, 10);
      this.$el.querySelectorAll('.js-option').forEach(function (option) {
        var numberOfVotes = parseInt(option.dataset.votes, 10);
        ...
        var percentage = "".concat(Math.round(numberOfVotes / totalVotes * 100), "%");
...
__webpack_require__(/*! D:\Web\poll-garden\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Web\poll-garden\resources\sass\app.scss */"./resources/sass/app.scss");
